...
export default function Home() {
  return (
    ...
    <ScrollCycle
      sectionA={
        <section style={{ minHeight: '150svh', display: 'grid', placeItems: 'center', backgroundColor: 'white'  }}>
          <h1>Section A</h1>
        </section>
      }
      sectionB={
      ...
      topStripB={
        <div style={{ height: '100%', display: 'grid', placeItems: 'center', zIndex: 10, backgroundColor: 'blue'}}>
          <p>Top strip (B)</p>
        </div>
      }
    />
