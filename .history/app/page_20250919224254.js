...
export default function Home() {
  return (
    ...
    <ScrollCycle
      sectionA={
        <section style={{ minHeight: '150svh', display: 'grid', placeItems: 'center', backgroundColor: 'blue'  }}>
          <h1>Section A</h1>
        </section>
      }
      sectionB={
      ...
      bottomStripA={
        <div style={{ height: '100%', display: 'grid', placeItems: 'center', zIndex: 1, backgroundColor: 'white' }}>
          <p>Bottom strip (A)</p>
        </div>
      }
      topStripB={
